...
def run_agent(user_message: str, max_iterations: int = 10) -> str:# 2. Iteration cap exists ONLY as a backstop against runaway loops.
    ...
    for iteration in range(max_iterations):
        ...
        #====================================================================================================================
        # 1a. BREAK it stop condition : removed  if response.stop_reason == "end_turn":........
        # When the model returns end_turn, the broken loop goes:
        # if iteration == 5: break → False (iteration is 0)
        # if response.stop_reason == "tool_use": → False
        # Falls through to raise RuntimeError(f"Unexpected stop_reason: 'end_turn'")
        # You will see one stop_reason: end_turn line, then a traceback.
        #====================================================================================================================
        if iteration == 5:
            break
        ...
        # A defensive rail that raises on any unhandled stop_reason is what 
        # makes the anti-pattern visible. Real codebases often lack this rail.
        # raise RuntimeError(
        ...
        # # 1b. Break IT : Replace raise RuntimeError(...) line with pass
        # # This is the canonical Domain 1.1 anti-pattern in its silent form. 
        # # No exception, no signal, just wasted tokens and a None return.
        pass

        # #====================================================================================================================
    
    # #====================================================================================================================
    #    # 1c. Break IT : Remove the post-loop backstop.
